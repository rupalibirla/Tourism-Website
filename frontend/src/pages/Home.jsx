            ...
            <Col lg="6">
              <div className="hero__content">
                ...
                <h1>
                  ...
                  <span1 className="hightlight"> memories</span1>
                </h1>
                <p>
                  ...
                  Occasions, They Weight Our Memories To The Good.” – Gretchen
                  Rubin
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col lg="6">
              <div className="experience__content">
                ...
                <p>
                  The results are in! Explore this year's expert-approved list
                  of must-see destinations, places, and unforgettable
                  experiences guaranteed to inspire.
                </p>
              </div>
